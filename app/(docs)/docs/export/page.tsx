  ...
  return (
    <>
      ...
      <p className="docs-lead">
        Everything is encoded in your browser, from the same clock the preview uses.
        What you export is frame-for-frame what you watched.
      </p>
        ...
        <table className="docs-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Smaller at the same quality; not every tool ingests it.</td>
            </tr>
            <tr>
      ...
      <p>
        ...
        dialog, because the 2D and 3D renderers implement one capture contract.
      </p>
