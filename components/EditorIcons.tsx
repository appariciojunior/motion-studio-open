...
//      which need mass at 14px, and on GithubIcon, which is the real
//      brand mark rather than a drawn glyph and keeps its own 16-unit
//      viewBox for that reason.
// ============================================================
...
// The real GitHub mark (primer/octicons `mark-github-16.svg`, MIT), not a
// drawn glyph — a branch-and-node stand-in read as "some repo", not GitHub.
// Kept on its native 16-unit viewBox rather than redrawn onto the 20-unit grid.
export function GithubIcon(props: EditorIconProps) {
  return <svg {...iconPropsFilled(props)} viewBox="0 0 16 16">
