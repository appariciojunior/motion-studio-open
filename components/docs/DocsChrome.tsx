...
import DocsPalette from '@/components/docs/DocsPalette';
...
import { CloseIcon, MenuIcon } from '@/components/docs/DocsIcons';
  ...
  return (
    <div className={`docs-shell ${menuOpen ? 'menu-open' : ''}`}>
      ...
      <div className="docs-body">
        <DocsSidebar open={menuOpen} onOpenSearch={openSearch} />
