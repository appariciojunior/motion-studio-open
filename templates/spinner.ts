...
function cameraRef(v: Record<string, any>) {
  ...
  return {
    ...
    panX: (num(v.offsetX) / 100) * half,
    panY: (num(v.offsetY) / 100) * half,
  };
}
...
export const spinnerVariants: Template[] = [
  ...
  variant(spinner, 'spinner-04', 'Spinner 04', {
    count: 18, axis: 'vertical', rotateX: -18, rotateY: -4, offsetY: 7, perspective: 840,
  }),
  ...
  variant(spinner, 'hinge-04', 'Hinge 04', {
    count: 12, hinge: 282, rotateY: -15, zoom: 75, perspective: 1345, offsetX: -5,
  }),
  ...
  variant(spinner, 'fan-01', 'Fan 01', {
    ...
    rotateY: -60, rotateZ: -180, zoom: 125, perspective: 250, offsetX: -16, backface: 'hide',
  }, { id: 'smooth' }, { cardAspect: 4 / 5 }),
  variant(spinner, 'fan-02', 'Fan 02', {
    count: 6, diameter: 50, zoom: 180, perspective: 150, offsetY: 34,
  }, undefined, { cardAspect: 4 / 5 }),
  variant(spinner, 'fan-03', 'Fan 03', {
    count: 9, axis: 'vertical', diameter: 440, fade: 13, rotateX: -26, rotateY: 120,
    zoom: 127, perspective: 1000, offsetX: 34, offsetY: 5, backface: 'hide',
  }, undefined, { cardAspect: 4 / 5 }),
];
