...
export const orbit3dVariants: Template[] = [
  ...
  variant(ringStream, 'orbit-3d-04', 'Ring Pure 01', {
    count: 18, ringSizePct: 57, cardSizePct: 74, cardBend: 3, facing: 'ring', fade: 30,
  ...
  variant(ringStream, 'orbit-3d-05', 'Ring Pure 02', {
    count: 9, ringSizePct: 57, cardSizePct: 87, cardBend: 7.5, facing: 'ring', fade: 15,
  ...
  variant(ringStream, 'orbit-3d-07', 'Ring Pure 04', {
    count: 18, ringSizePct: 57, cardSizePct: 87, cardBend: 4, facing: 'ring', fade: 15,
  ...
  variant(ringStream, 'orbit-3d-08', 'Ring Pure 05', {
    count: 12, ringSizePct: 57, cardSizePct: 87, cardBend: 5.5, facing: 'ring', fade: 15, ringOffset: 5,
    tiltX: 0, perspective: 25, camDistance: 1, speed: 0.2, direction: 'reverse', shadow: 'off', cornerRadius: 10,
  }, { id: 'custom', bezier: [0.8, 0, 0.2, 1] }, { cardAspect: 1 /* 1:1 */ }),
  ...
  variant(ringStream, 'orbit-3d-09', 'Ring Pure 06', {
    count: 18, ringSizePct: 57, cardSizePct: 100, cardBend: 4.5, facing: 'ring', fade: 15, ringOffset: 5,
  ...
  variant(ringStream, 'orbit-3d-10', 'Ring Carousel 01', {
    count: 18, ringSizePct: 57, cardSizePct: 74, cardBend: 0, facing: 'camera', fade: 30,
    tiltX: -10, ringYaw: -10, ringRoll: 50, perspective: 15, camDistance: 1, speed: 0.3, direction: 'reverse', shadow: 'off', cornerRadius: 10,
  }, { id: 'linear' }, { cardAspect: 1 /* 1:1 */ }),
  variant(ringStream, 'orbit-3d-11', 'Ring Carousel 02', {
    count: 9, ringSizePct: 57, cardSizePct: 87, cardBend: 0, facing: 'camera', fade: 15,
  ...
  variant(ringStream, 'orbit-3d-12', 'Ring Carousel 03', {
    count: 9, ringSizePct: 57, cardSizePct: 87, cardBend: 0, facing: 'camera', fade: 15, scaleContrast: 50,
  ...
  variant(ringStream, 'orbit-3d-13', 'Ring Carousel 04', {
    count: 20, ringSizePct: 57, cardSizePct: 200, cardBend: 0, facing: 'camera', fade: 15, scaleContrast: 200,
  ...
  variant(ringStream, 'orbit-3d-14', 'Ring Carousel 05', {
    count: 9, ringSizePct: 57, cardSizePct: 118, cardBend: 0, facing: 'camera', fade: 15, scaleContrast: 200,
  ...
  variant(ringStream, 'orbit-3d-15', 'Ring Lightroom 01', {
    count: 10, ringSizePct: 57, cardSizePct: 94, cardBend: 7.5, facing: 'ring', fade: 0, fadeMode: 'alpha', flip: 'yes',
  ...
  variant(ringStream, 'orbit-3d-16', 'Ring Lightroom 02', {
    count: 10, ringSizePct: 57, cardSizePct: 94, cardBend: 0, facing: 'ring', fade: 0, fadeMode: 'alpha', flip: 'yes',
  ...
  variant(ringStream, 'orbit-3d-18', 'Ring Lightroom 04', {
    count: 9, ringSizePct: 57, cardSizePct: 61, cardBend: 0, facing: 'ring', fade: 0, fadeMode: 'alpha', flip: 'yes',
  ...
  variant(ringStream, 'orbit-3d-19', 'Ring Lightroom 05', {
    count: 24, ringSizePct: 57, cardSizePct: 100, cardBend: 0, facing: 'ring', fade: 0, fadeMode: 'alpha', flip: 'yes',
  ...
  variant(ringStream, 'orbit-3d-20', 'Ring Bloom 01', {
    count: 12, ringSizePct: 57, cardSizePct: 85, cardBend: 0, facing: 'ring', fade: 25, cardTilt: 15,
  ...
  variant(ringStream, 'orbit-3d-21', 'Ring Bloom 02', {
    count: 12, ringSizePct: 57, cardSizePct: 100, cardBend: 0, facing: 'camera', fade: 0, fadeMode: 'alpha', scaleContrast: 200,
  ...
  variant(ringStream, 'orbit-3d-23', 'Ring Bloom 04', {
    count: 12, ringSizePct: 57, cardSizePct: 100, cardBend: 0, facing: 'camera', fade: 0, fadeMode: 'alpha', cardTilt: -44,
  ...
  variant(ringStream, 'orbit-3d-24', 'Ring Bloom 05', {
    count: 16, ringSizePct: 57, cardSizePct: 67, cardBend: 0, facing: 'ring', fade: 0, fadeMode: 'alpha',
